...
import (
	...
	"naffets.eu/ecs-deployment-manager/controllers"
...
func init() {
	...
	utilruntime.Must(ecsdeploymentmanagerv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "1af14ce2.naffets.eu",
	})
	if err != nil {
	...
	if err = (&controllers.TargetGroupReconciler{
